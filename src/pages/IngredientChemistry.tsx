...
const IngredientChemistry = () => {
  ...
  const analyzeChemistry = async () => {
    ...
    try {
      ...
      toast.error(
        error instanceof Error ? error.message : "Failed to analyze chemistry"
      );
    } finally {
  ...
  const handleGenerateRecipe = (dish: SuggestedDish) => {
    navigate(
      `/generate?ingredients=${ingredients.join(",")}&dish=${encodeURIComponent(
        dish.name
      )}`
    );
  };
  ...
  return (
    <Layout>
      ...
      <div
        ...
        style={{ backgroundImage: "url('/food lab.png')" }}
      >
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="text-center max-w-2xl mx-auto mb-12">
                ...
                <p className="text-white">
                  Discover how your ingredients pair together using molecular
                  gastronomy principles. Get compatibility scores, flavor
                  profiles, and dish suggestions.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
                ...
                <div className="space-y-6">
                  {isAnalyzing && (
                    <LoadingSpinner text="Analyzing flavor chemistry..." />
                  )}
                    ...
                    <div className="space-y-6 animate-fade-up">
                      ...
                      <div className="bg-card rounded-2xl shadow-card border border-border p-6">
                        <div className="flex items-center justify-between mb-4">
                          ...
                          <span
                            className={`text-sm font-medium px-3 py-1 rounded-full bg-accent ${getScoreColor(
                              result.score
                            )}`}
                          >
                            {result.label}
                        ...
                        {result.flavorProfile && (
                          <div className="mt-6 pt-6 border-t border-border">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {result.flavorProfile.dominant.map(
                                (flavor, idx) => (
                                  <span
                                    key={`dom-${idx}`}
                              ...
                              {result.flavorProfile.secondary.map(
                                (flavor, idx) => (
                                  <span
                                    key={`sec-${idx}`}
