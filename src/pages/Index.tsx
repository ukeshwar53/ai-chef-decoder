      ...
      >
        ...
        <div className="container mx-auto px-4 py-20 md:py-32 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1
              className="font-heading text-4xl md:text-6xl lg:text-7xl font-bold text-yellow-500 mb-6 animate-fade-up"
              style={{ animationDelay: "0.1s" }}
            >
              Transform Ingredients Into
              <span className="text-yellow-500 block mt-2">Culinary Masterpieces</span>
            </h1>
