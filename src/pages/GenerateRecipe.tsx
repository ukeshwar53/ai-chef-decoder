...
import { Sparkles, Leaf, Globe, Heart, Loader2, CameraIcon, Type, Beaker } from "lucide-react"
...
const dietOptions = ["None", "Vegetarian", "Vegan", "Keto", "Low-Carb", "High-Protein", "Gluten-Free", "Dairy-Free"]
      ...
      <section className="py-12 md:py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-4">Generate Your Perfect Recipe</h1>
            ...
            <div className="bg-card rounded-2xl border border-border shadow-sm p-6 md:p-8">
              <Tabs value={inputMode} onValueChange={(v) => setInputMode(v as "text" | "camera")}>
                ...
                <TabsContent value="text" className="mt-0">
                  <h2 className="text-xl font-semibold text-foreground mb-6">Your Ingredients</h2>
                ...
                <TabsContent value="camera" className="mt-0">
                  <h2 className="text-xl font-semibold text-foreground mb-6">Capture Ingredients</h2>
                    ...
                    <div className="mt-4 p-4 bg-accent rounded-xl">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {ingredients.map((ing, idx) => (
                          <span key={idx} className="px-3 py-1 bg-background rounded-full text-sm text-foreground">
                            {ing}
                          </span>
                        ))}
                      </div>
              ...
              <div className="space-y-3 mt-8">
                ...
                {ingredients.length >= 2 && (
                  <Button variant="outline" className="w-full bg-transparent" onClick={handleCheckChemistry}>
            ...
            <div className="space-y-6">
              ...
              {recipe && !isLoading && (
                <div className="space-y-4">
                  ...
                  {user && (
                    <Button className="w-full" onClick={handleSaveRecipe} disabled={isSaving}>
                      {isSaving ? (
